<div class="flex flex-col h-full" x-data="kanban(@this)">
    ...
    <div class="flex-shrink-0 flex items-center gap-4 px-6 h-14 border-b border-gray-800 bg-gray-900">
        <div class="flex items-center gap-2.5">
            <div class="w-7 h-7 rounded-md flex items-center justify-center text-xs font-bold text-white"
                 style="background-color: {{ $project->color }}">
                {{ strtoupper(substr($project->key, 0, 2)) }}
            </div>
            <span class="font-semibold text-white text-sm">{{ $project->name }}</span>
