<div class="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-xl w-full max-w-lg shadow-2xl" @click.stop>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-800">
            <h2 class="text-base font-semibold text-white">Edit Project</h2>
        ...
        <div class="p-6 space-y-5">
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block text-sm text-gray-400 mb-1.5">Key</label>
        ...
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-800">
            <a href="{{ route('projects.show', $project) }}" wire:navigate
               class="px-4 py-2 text-sm text-gray-400 hover:text-gray-200 transition-colors">Cancel</a>
